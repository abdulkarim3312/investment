                        ...
                        <tbody>
                            @foreach ($user as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn waves-effect icon_size waves-light btn btn-primary btn-sm btn-sm-custom ml-1 mb-0" title="Edit User Details" href="{{ route('users.show', $item->id) }}" class="btn btn-info"><i class="fa fa-eye"></i></a>
