        ...
        <div class="card-header pb-0">
            <div class="row">
                <div class="col-lg-6 col-7">
                    <h6>Agreement Type List</h6>
                </div>
                <div class="col-lg-6 col-5 my-auto text-end">
                    <div class="float-lg-end">
                        <a href="{{ route('agreement.create') }}" class="btn btn-primary float-right">Add new</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($type as $item)
                            <tr>
                                ...
                                <td>
                                    <a class="btn waves-effect icon_size waves-light btn-success btn-sm btn-sm-custom ml-1  mb-0" title="Edit Service Details" href="{{ route('agreement.edit', $item->id) }}">
                                    ...
                                    <form id="deleteForm{{$item->id}}" action="{{route('agreement.destroy', [$item->id])}}" method="post" style="display:none">
                                        @csrf
                                        @method('delete')
