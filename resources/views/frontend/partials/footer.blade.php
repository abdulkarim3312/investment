<!-- Footer Style -->
<footer class="main-footer style-two alternate" style="background-image: url({{ asset('frontend/assets/images/background/footer-bg_two.jpg') }})">
    <div class="footer-icon-six" style="background-image: url({{ asset('frontend/assets/images/icons/footer-icon-6.png') }})"></div>
    <div class="footer-icon-seven" style="background-image: url({{ asset('frontend/assets/images/icons/footer-icon-7.png') }})"></div>
    <div class="footer-icon-eight" style="background-image: url({{ asset('frontend/assets/images/icons/footer-icon-4.png') }})"></div>
